...
midleft = Motor(Ports.PORT20,GearSetting.RATIO_6_1,True)
midright = Motor(Ports.PORT19,GearSetting.RATIO_6_1,False)
Rside = MotorGroup(frontright,backright,midright)
Lside = MotorGroup(frontleft,backleft,midleft)
